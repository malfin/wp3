...
<header class="header" id="home">
    <div class="container">
        ...
        <div class="img-holder">
            <img src="<?= get_template_directory_uri() ?>/assets/imgs/man.svg" alt="">
        </div>
    </div>
...
<section id="about" class="section mt-3">
    <div class="container mt-5">
        <div class="row text-center text-md-left">
            <div class="col-md-3">
                <img src="<?= get_template_directory_uri() ?>/assets/imgs/avatar.jpg" alt="" class="img-thumbnail mb-4">
            </div>
            <div class="pl-md-4 col-md-9">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident, pariatur, aperiam aut autem
                    voluptas odit. Odio ducimus delectus totam sed aliquam sequi praesentium mollitia, illum repudiandae
                    quidem quod, magni magnam.</p>
...
<section id="service" class="section">
    <div class="container text-center">
        ...
        <p class="mb-5 pb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In alias dignissimos. <br> rerum
            commodi corrupti, temporibus non quam.</p>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-1.jpg" alt="">
                    <div class="overlay">
                ...
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-2.jpg" alt="">
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
            ...
            <div class="col-sm-4">
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-3.jpg" alt="">
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                ...
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-4.jpg" alt="">
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
            ...
            <div class="col-sm-4">
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-5.jpg" alt="">
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                ...
                <div class="img-wrapper">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/folio-6.jpg" alt="">
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="card testmonial-card border">
                        <div class="card-body">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/avatar-1.jpg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam nostrum voluptates in
                                enim vel amet?</p>
                ...
                <div class="carousel-item">
                    <div class="card testmonial-card border">
                        <div class="card-body">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/avatar-2.jpg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam nostrum voluptates in
                                enim vel amet?</p>
                ...
                <div class="carousel-item">
                    <div class="card testmonial-card border">
                        <div class="card-body">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/avatar-3.jpg" alt="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam nostrum voluptates in
                                enim vel amet?</p>
        ...
        <div class="row text-left">
            <div class="col-md-4">
                <div class="card border mb-4">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/blog-1.jpg" alt=""
            ...
            <div class="col-md-4">
                <div class="card border mb-4">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/blog-2.jpg" alt=""
                         class="card-img-top w-100">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border mb-4">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/imgs/blog-3.jpg" alt=""
                         class="card-img-top w-100">
                    <div class="card-body">
